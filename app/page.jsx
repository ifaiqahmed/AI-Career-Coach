...
&quot;
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background" >
        <div className="container mx-auto px-4 md:px-6" >
          ...
          <p className="text-muted-foreground" >Find answers to the most common questions</p>
          </div>
    ...
    <AccordionContent>
      ...
      <section className="w-full" >
        <div className="mx-auto py-24 gradient rounded-lg" >
          ...
          <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl" >Join thousands of professionals who are advancedt
